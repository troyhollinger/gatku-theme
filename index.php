...
<div class="no-ie wrapper">  
    <section id="home" class="window window1">
        ...
        <div id="owl-example" class="owl-carousel">
            ...
            <div><p id="spearo" class="about-text">We Know the Spearo's Needs Because WE ARE SPEAROS&trade;</p></div>
        </div>
    </section>
                            ...
                            <div class="module-section measurements-section">
                                ...
                                <div class="measurements-section-left">
                                    ...
                                    <div class="polespear-cross-section first-polespear-cross-section">
                                        ...
                                        <span class="suggested-pole-length"><?php echo the_field('suggested_poles_1_length'); ?>&rdquo;</span>
                                    </div>
                            ...
                            <div class="info-module-content">
                                ...
                                <div class="module-section measurements-section">
                                    <div class="measurements-section-left">
                                        ...
                                        <span class="suggested-pole-length"><?php echo the_field('measurement_product_image_1_length'); ?>&rdquo;</span>
                                        <img class="measurements-suggested-image" src="<?php echo the_field('measurement_product_image_2') ?>">
                                        <span class="suggested-pole-length"><?php echo the_field('measurement_product_image_2_length'); ?>&rdquo;</span>
                                        <span class="suggested-pole-text"><?php echo the_field('measurement_page_text')?></span>
                                        
                                        <img class="measurements-suggested-image" src="<?php echo the_field('suggested_heads_image_1')?>">
                                        <span class="suggested-pole-length"><?php echo the_field('suggested_heads_1_length');?>&rdquo;</span>
                                    
                                    
                                        <img class="measurements-suggested-image" src="<?php echo the_field('suggested_heads_image_2')?>">
                                        <span class="suggested-pole-length"><?php echo the_field('suggested_heads_2_length');?>&rdquo;</span>
    ...
    <section class="window" id="you-window">
      <div id="you-container">
        <p id="you-text"> <a href="mailto:dustin@gatku.com"><strong>SEND US YOUR PHOTOS</strong></a> - FISH IN ONE HAND, POLESPEAR IN THE OTHER </p>
    ...
    <section class="window" id="contact-window">
      <div class="contact-desktop">
        ...
        <div class="whitespace">
          ...
          <p>2005 - <?php echo date('Y') ;?> &copy; GATKU / ALL RIGHTS RESERVED. <span class="fade">| &nbsp;<a href="http://www.troyhollinger.com" target="_blank">WE LOVE TROY</a>&nbsp;</span>|&nbsp; <a href="<?php bloginfo('url') ;?>/media ">MEDIA</a> </p>
        </div>
      ...
      <div class="contact-mobile">
        ...
        <div class="m-contact-image-container"><a href="mailto:dustin@gatku.com"><img src="<?php echo get_template_directory_uri(); ?>/img/mail.png"></a></div>
        ...
        <div class="m-contact-info">
          <p><strong>THE GATKU</strong><br>1250 Pioneer Way Suite H, El Cajon, CA 92020</p>
          <p><strong>Customer Service</strong> - Email: dustin@gatku.com / Phone +001 619 507-3860</p>
          <p>GATKU&copy;2013 ALL RIGHTS RESERVED.</p>
        </div>
      </div>
    </section>
